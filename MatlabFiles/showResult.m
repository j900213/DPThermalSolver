...
%legend(line([1 3 5 7]),  'Calculated speed trajectpry', 'Legal speed limits', 'Calculated Boundary line', 'Calibration')
legend(line([1 3 5]),  'Calculated speed trajectpry', 'Legal speed limits', 'Calculated Boundary line')
hold off;
...
ylabel('Speed (km/h)');
%legend(line([1 2 3 5 7]),  'Calculated speed trajectpry', 'Actual speed trajectory','Legal speed limits', 'Calculated Boundary line', 'Calibration')
legend(line([1 3]),  'Calculated optimal thermal trajectpry', 'User required temperature')
hold off;
